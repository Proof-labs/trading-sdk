...
export {
  ...
  type PendingTriggerHistoryPayloadBase,
  type PendingTriggersAttachedHistoryPayload,
  type PendingTriggersDiscardedHistoryPayload,
  type PendingTriggerDiscardReason,
