...
Thanks for your interest in [`@prooftrade/trading-sdk`](https://github.com/Proof-labs/trading-sdk) —
...
| ------------------------------------------------------- | ------------------- | ------------------------------------------------------------ |
| **TypeScript** (published as `@prooftrade/trading-sdk`) | repo root → `dist/` | `npm install && npm run build`, then `npm run test` (vitest) |
...
`@prooftrade/trading-sdk` follows [semantic versioning](https://semver.org/). Breaking changes
