...
| Structured HTTP 200/503 refusal without admission/verdict fields | `transport` (code 1 / 503), original error reason | **No** — the gateway refused admission; unknown 5xx or contradictory responses still reconcile by hash                                                                                                                     |
